    ...
    return BottomNavyBar(
      ...
      items: [
        BottomNavyBarItem(
          ...
          activeColor: indexOfBTB == 0 ? Colors.blue : Colors.grey,
        ),
        BottomNavyBarItem(
            icon: const Icon(Icons.favorite),
            title: const Text('Favorite'),
            activeColor: indexOfBTB == 1 ? Colors.blue : Colors.grey),
        BottomNavyBarItem(
            icon: const Icon(Icons.shopping_cart),
            title: const Text('Carts'),
            activeColor: indexOfBTB == 2 ? Colors.blue : Colors.grey),
        BottomNavyBarItem(
            icon: const Icon(Icons.person),
            title: const Text('Profile'),
            activeColor: indexOfBTB == 3 ? Colors.blue : Colors.grey),
      ],
    );
  }
